...
::: {.column width="60%"}
```{r correlation, echo=FALSE, fig.cap = "One year rolling return correlations", fig.align='center', out.width = "90%"}
...
Figure \@ref(fig:backwardation2) shows that in time $t$, the expected spot price of the December contract is higher than the expected spot price of the March contract, and the expected spot price of the March contract is higher than the expected spot price of the May contract.

Figure \@ref(fig:contango2) shows that in time $t$, the expected spot price of the December contract is lower than the expected spot price of the March contract, and the expected spot price of the March contract is lower than the expected price of the May contract.
...
Figure \@ref(fig:joinedprices) show how the cumulative roll and the joined prices are calculated. 

```{r joinedprices, echo=FALSE, fig.cap = "Joined Futures with Backwardation Data", fig.align='center', out.width = "50%"}
...
Table \@ref(tab:joined-futures) show how the cumulative roll and the joined prices are calculated. 
...
<!-- By putting echo = F, the code runs but is not displayed on the rendered file.  -->
...
Figure \@ref(fig:back-futures-spot) shows that the spot and joined futures began with the same value (not shown in graph), but the ending gap of `r combined_21$joined[combined_21$time == "2021-11-19"]` - `r combined_21$spot[combined_21$time == "2021-11-19"]` = `r combined_21$joined[combined_21$time == "2021-11-19"] - combined_21$spot[combined_21$time == "2021-11-19"]` is roughly equal to the `r combined_21$cum_roll[combined_21$time == "2021-10-20"]` cumulative roll yield shown in Table \@ref(tab:roll-yield-defined). 
...
** Figures \@ref(fig:back-left) and \@ref(fig:back-right) are not in the PPT slides **

:::: {.columns}

::: {.column width="50%"}
```{r back-left, echo=FALSE, fig.cap = "Adjusted Spot and Joined Futures, July 2021 - Sep 2021", fig.align='center', out.width = "100%"}
knitr::include_graphics("Images/back_left.png")
```
:::

::: {.column width="50%"}
```{r back-right, echo=FALSE, fig.cap = "Adjusted Spot and Joined Futures, Sep 2021 - Nov 2021", fig.align='center', out.width = "100%"}
knitr::include_graphics("Images/back_right.png")
```
:::
::::
...
Figure \@ref(fig:con-futures-spot) shows 
...
::: {.column width="50%"}
```{r contango-left, echo=FALSE, fig.cap = "Adjusted Spot and Joined Futures, Oct 2018 - Dec 2018", fig.align='center', out.width = "80%"}
knitr::include_graphics("Images/contango_left.png")
```
:::

::: {.column width="50%"}
```{r contango-right, echo=FALSE, fig.cap = "Adjusted Spot and Joined Futures, Dec 2018 - Feb 2019", fig.align='center', out.width = "80%"}
knitr::include_graphics("Images/contango_right.png")
```
:::
::::

Figure \@ref(fig:carry-cost) 

```{r carry-cost, echo=FALSE, fig.cap = "Graph with Carry Cost", fig.align='center', out.width = "75%"}
knitr::include_graphics("Images/carry_graph.png")
```
